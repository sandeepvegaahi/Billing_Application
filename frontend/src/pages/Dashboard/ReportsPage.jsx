...
//         Generate financial and due reports
//       </p>
...
//         {activeTab === "due" && (
//           <div className="text-gray-500 text-sm">Due Reports coming soon</div>
//         )}
//         {activeTab === "summary" && (
//           <div className="text-gray-500 text-sm">Summary Reports coming soon</div>
//         )}
//       </div>
//     </div>
//   );
