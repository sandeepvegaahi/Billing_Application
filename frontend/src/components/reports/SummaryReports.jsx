...
const SummaryReports = () => {
  ...
  return (
    <>
      <h3 className="font-medium mb-1">Generate Summary Report</h3>
      <p className="text-sm text-gray-500 mb-4">View summary of payments collected</p>
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="p-2 text-left">Total Collected</th>
            </tr>
          </thead>
          <tbody>
            {reportData.map((row, idx) => (
              <tr key={idx} className="border-t">
                ...
                <td className="p-2">₹{row.totalCollected}</td>
              </tr>
            ))}
          </tbody>
        </table>
